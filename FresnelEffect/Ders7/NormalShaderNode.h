...
private:
    GLuint UniformMVP, uniProjection, uniNormalMatrix, uniDepthScale;
    ...
    void generateBuffers(){
        ...
        printf("uniProjection: %d\n",uniProjection);

		uniNormalMatrix = glGetUniformLocation(programId, "NormalMatrix");
        printf("uniNormalMatrix: %d\n",uniNormalMatrix);

		uniDepthScale = glGetUniformLocation(programId, "DepthScale");
        printf("uniDepthScale: %d\n",uniDepthScale);
